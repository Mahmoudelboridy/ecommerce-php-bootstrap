...
$status='pending';
 ...
 (user_id,amount_due,invoice_number,total_products
 ,order_date,order_status)
   VALUES ('$user_id','$subtotal',
   '$invoice_num','$count_products',NOW(),'$status')";
 ...
 (user_id,invoice_number,product_id
 ,quantity,order_status)
   VALUES ('$user_id',
   '$invoice_num','$product_id','$quantity','$status')";
